{:beam_file, Test2,
 ...
 [vsn: [264_819_182_465_788_944_622_532_035_345_538_392_619]],
 [
   version: ~c"8.3.1",
   options: [:no_spawn_compiler_process, :from_core, :no_core_prepare, :no_auto_import],
   source: ~c"/Users/angelika/Documents/code/tco_test/test2.ex"
 ],
 [
   {:function, :__info__, 1, 2,
    [
      {:label, 1},
      {:line, 0},
      {:func_info, {:atom, Test2}, {:atom, :__info__}, 1},
      {:label, 2},
      {:select_val, {:x, 0}, {:f, 9},
       {:list,
        [
      ...
      {:label, 9},
      {:call_only, 1, {Test2, :"-inlined-__info__/1-", 1}}
    ]},
   {:function, :my_test_function, 1, 11,
    [
      {:line, 1},
      {:label, 10},
      {:func_info, {:atom, Test2}, {:atom, :my_test_function}, 1},
      {:label, 11},
      {:test, :is_lt, {:f, 12}, [integer: 10, x: 0]},
      {:line, 2},
      {:gc_bif, :-, {:f, 0}, 1, [{:tr, {:x, 0}, :any}, {:integer, 5}], {:x, 0}},
      {:call_only, 1, {Test2, :my_test_function, 1}},
      {:label, 12},
      :return
    ]},
   {:function, :module_info, 0, 14,
    [
      {:line, 0},
      {:label, 13},
      {:func_info, {:atom, Test2}, {:atom, :module_info}, 0},
      {:label, 14},
      {:move, {:atom, Test2}, {:x, 0}},
   ...
   {:function, :module_info, 1, 16,
    [
      {:line, 0},
      {:label, 15},
      {:func_info, {:atom, Test2}, {:atom, :module_info}, 1},
      {:label, 16},
      {:move, {:x, 0}, {:x, 1}},
      {:move, {:atom, Test2}, {:x, 0}},
      {:call_ext_only, 2, {:extfunc, :erlang, :get_module_info, 2}}
   ...
   {:function, :"-inlined-__info__/1-", 1, 18,
    [
      {:line, 0},
      {:label, 17},
      {:func_info, {:atom, Test2}, {:atom, :"-inlined-__info__/1-"}, 1},
      {:label, 18},
      {:jump, {:f, 17}}
    ]}
 ]}
